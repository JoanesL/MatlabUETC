...
%All different runs of the same simulation should have same kt and r
%so first file is enough.
[kt,r]=UETCinfoRead(filenamePre,idString{1});
...
%Load correlators
for i=1:nRuns
    fileName=[filenamePre 'ETC' Cname idString{i} '.dat'];
